...
export default function ItemLibrary({ selectedId, onSelectId, onClearSelected }) {
  ...
  const STAT_CONFIG = [
    ...
    { key: 'ability_power', label: 'Poder Mágico', color: 'text-purple-400', unit: '' },
    ...
    { key: 'critical_impact', label: 'Golpe Crítico', color: 'text-amber-400', unit: '%' },
    ...
    { key: 'ability_haste', label: 'Aceleración', color: 'text-cyan-400', unit: '' },
